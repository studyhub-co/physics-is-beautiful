...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    onVectorChanged: (x_component, y_component) =>
      dispatch(
        updateVectorAnswerComponents(ownProps.uuid, x_component, y_component),
      ),
    onVectorCheckTypeChanged: e =>
      dispatch(updateVectorCheckType(ownProps.uuid, e.target.value)),
    onSetNull: () =>
      dispatch(updateVectorAnswerComponents(ownProps.uuid, null, null)),
  }
}
