...
export default (
  <Switch>
    ...
    <Route
      ...
      path={
        BASE_URL +
        ':resource_title([A-Za-z0-9_\\-\\.]+)/problems/:problem_title([A-Za-z0-9_\\-\\.]+)/solutions/:solution_title([A-Za-z0-9_\\-\\.]+)/:uuid'
      }
    ...
    <Route
      ...
      path={
        BASE_URL +
        ':resource_title([A-Za-z0-9_\\-\\.]+)/problems/:problem_title([A-Za-z0-9_\\-\\.]+)/:uuid'
      }
      component={ProblemView}
    />
    <Route
      exact
      path={BASE_URL + ':title([A-Za-z0-9_\\-\\.]+)/:uuid/'}
