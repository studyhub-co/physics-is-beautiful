// the same file as in editor editor\static\editor\js\components\thumbnail.jsx
...
export class EditableThumbnail extends React.Component {
  ...
  render() {
    const RootElement = props => {
      if (this.props.hasOwnProperty('asFragment') && this.props.asFragment) {
        return <React.Fragment>{props.children}</React.Fragment>
      } else {
        return <div className="selectable-image">{props.children}</div>
      }
    }

    return (
      <RootElement asFragment={this.props.asFragment}>
