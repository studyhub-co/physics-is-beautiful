...
const url_ts_1 = require("./url.ts");
function testSandboxOptions(url) {
    expect(url_ts_1.getSandboxOptions(url)).toMatchSnapshot();
}
describe('url parameters', () => {
    ...
    it('can handle multiple options', () => {
        testSandboxOptions('https://codesandbox.io/s/new?autoresize=1&view=editor&module=test&hidenavigation=1');
    });
});
