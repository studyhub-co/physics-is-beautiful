...
import { INormalizedModules } from '../../../../../../../../../../codesandbox-apps/codesandbox-importers/packages/types/index'
import denormalize from '../../../../../../../../../../codesandbox-apps/codesandbox-importers/packages/import-utils/src/utils/files/denormalize'
...
export const filesUploaded: AsyncAction<{
  ...
  async ({ state, effects, actions }, { files, directoryShortid }) => {
    alert('files uploading won implemented')
...
export const massCreateModules: AsyncAction<{
  ...
  async (
    ...
    try {
      ...
      console.log('Unable to create new files')
...
export const moduleCreated: AsyncAction<{
  ...
  async (
    ...
    try {
      ...
      alert('Unable to save new file:' + error)
...
export const moduleDeleted: AsyncAction<{
  ...
  try {
    ...
    alert('Could not delete file:' + error)
...
export const createModulesByPath: AsyncAction<{
  ...
  const sandbox = state.editor.currentSandbox
  // this function used by codesandbox editor with "Save as" signal
  // cbID - callback ID
