...
class ContributorsBadge extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement("a", { target: "_blank", rel: "noreferrer noopener", onClick: e => {
                e.stopPropagation();
            }, href: 'https://github.com/codesandbox/codesandbox-client/commits?author=' +
                username },
            react_1.default.createElement(Tooltip_1.default, { style: { display: 'flex' }, content: "Open Source Contributor to CodeSandbox" },
                react_1.default.createElement(IconBase, { style: style, width: "1em", height: "0.67em", viewBox: "0 0 284 192", fill: "none" },
