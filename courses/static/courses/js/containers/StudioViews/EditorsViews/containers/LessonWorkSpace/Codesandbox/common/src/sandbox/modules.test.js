...
describe.skip('root', () => {
    test('it resolves root path', () => {
        ...
        const directories = [];
        expect(modules_1.resolveModule(path, modules, directories)).toBe(modules[0]);
    });
    ...
    test('it resolves entry files', () => {
        ...
        expect(modules_1.resolveModule(path, modules, directories)).toBe(modules[1]);
    });
});
...
describe.skip('relative', () => {
    test('it finds something relative from directory', () => {
        ...
        expect(modules_1.resolveModule(path, modules, directories, '123123123')).toBe(modules[0]);
    });
    test('it finds current index', () => {
        ...
        expect(modules_1.resolveModule(path, modules, directories, '1312423432')).toBe(modules[0]);
    });
    ...
    test("it doesn't find itself if nothing is found", () => {
        ...
        expect(() => modules_1.resolveModule(path, modules, directories, null)).toThrow();
    });
});
describe.skip('preference', () => {
    ...
    describe('getModulesInDirectory', () => {
        it('lists all files in directory', () => {
            ...
            expect(modules_1.getModulesInDirectory(path, modules, directories).modules).toEqual(modules);
        });
