  ...
  render () {
    ...
    return (
      <div className={'pop-up-window'}>
        ...
        <Tabs name='editCourseProfileTabs'
          className='tabs'
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    changeCourseImage: (uuid, image) => dispatch(changeCourseImage(uuid, image)),
    onNameChange: (uuid, name) => dispatch(renameCourse(uuid, name)),
    onDescriptionChange: (uuid, text) => dispatch(saveCourseDescription(uuid, text)),
    changeCourseCoverPhoto: (uuid, image) => dispatch(changeCourseCoverPhoto(uuid, image))
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(EditCourseProfileView)
