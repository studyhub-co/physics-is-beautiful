    ...
    <Sheet>
      ...
      >
        ...
        <Link
          ...
          onClick={e => {
            e.preventDefault()
            history.push(`/courses/modules/${currentMaterial.lesson.module}`)
          }}
          variant="h5"
          underline="none"
        >
        ...
        <Link
          ...
          onClick={e => {
            e.preventDefault()
            history.push(`/courses/lessons/${currentMaterial.lesson.uuid}`)
          }}
          variant="h5"
          underline="none"
        >
      ...
      <AdSense.Google client="ca-pub-1780955227395785" slot="4334626488" />
    </Sheet>
  )
}
