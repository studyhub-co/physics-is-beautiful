...
try {
  ...
  self.importScripts(
    process.env.NODE_ENV === 'development'
      ? `${process.env.CODESANDBOX_HOST || ''}/static/courses/js/codesandbox-apps/babel.7.3.4.min.js`
      : `${process.env.CODESANDBOX_HOST || ''}/proxy/static/courses/js/codesandbox-apps/babel.7.3.4.min.js`
  );
} catch (e) {
  console.error(e);
}
