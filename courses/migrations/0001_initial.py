# Generated by Django 2.2.3 on 2019-10-03 10:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='')),
                ('position', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Position')),
                ('lesson_type', models.IntegerField(choices=[(courses.models.structure.LessonType(0), 0), (courses.models.structure.LessonType(1), 1)], default=0)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solution_text', models.CharField(blank=True, db_index=True, max_length=2048, null=True)),
