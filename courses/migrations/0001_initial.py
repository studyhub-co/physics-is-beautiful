# Generated by Django 2.2.3 on 2019-10-01 08:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Position')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.Profile')),
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', related_name='courses_modules', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
            ],
            options={
                'ordering': ['position'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', related_name='courses_units', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
            ],
            options={
                'ordering': ['position'],
            },
        ...
        migrations.AddField(
            model_name='lesson',
            name='tags',
            field=taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', related_name='courses_lessons', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='Game',
            fields=[
