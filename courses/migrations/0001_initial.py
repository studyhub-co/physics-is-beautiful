    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug_suffix', models.PositiveIntegerField(null=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('material_workflow_type', models.IntegerField(choices=[(courses.models.material.MaterialWorkflowType(10), 10), (courses.models.material.MaterialWorkflowType(20), 20), (courses.models.material.MaterialWorkflowType(80), 80), (courses.models.material.MaterialWorkflowType(90), 90)], default=10)),
                ('position', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Position')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='materials', to='courses.MaterialProblemType'),
        ),
        migrations.AddField(
            model_name='material',
            name='tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(courses.models.lesson_progress.LessonProgressStatus(0), 0), (courses.models.lesson_progress.LessonProgressStatus(10), 10), (courses.models.lesson_progress.LessonProgressStatus(20), 20), (courses.models.lesson_progress.LessonProgressStatus(30), 30)], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses_user_dashboard', to='courses.Course')),
