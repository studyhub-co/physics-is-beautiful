# Generated by Django 2.2.8 on 2020-01-14 20:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_id', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.Profile')),
                ('directory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='directories', to='courses.MaterialProblemTypeSandboxDirectory')),
