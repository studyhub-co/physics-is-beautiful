...
router.register(r'materials', apis.MaterialViewSet, base_name='materials')
...
public_router.register(r'materials', apis_public.MaterialViewSet, base_name='public_materials')
