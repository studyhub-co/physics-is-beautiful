...
class TeacherClassroomStudentsView extends React.Component {
  ...
  syncExternalStudents() {
    ...
    this.props.googleActions.googleFetchAndSaveClassroomsStudents(
    ...
    return (
      <div>
          ...
          <Row>
            <Col sm={7} md={7} className={'vcenter'}>
              <span className={'gray-text'}>
                Keep your Google Classroom in sync
              </span>
            </Col>
            <Col sm={5} md={5}>
              <button
        ...
        <Route
          ...
          component={StudentClassroomProfileView}
        />
        {isExactUrl && this.props.classroomTeacher ? (
          <span>
            {this.props.teacherClassroomStudentsList
              ? this.props.teacherClassroomStudentsList.map(function(
                  student,
                  i,
                ) {
                  return (
                ...
                this)
              : null}
            {this.props.teacherClassroomStudentsList.length === 0 ? (
              <p style={{ margin: '2rem' }}>
        ...
        {!isExactUrl &&
        this.props.classroomTeacher &&
        this.props.classroomTeacher.count_students === 0 ? (
          <div className={'gray-background-info-panel'}>
            No students have joined your classroom yet. <br />
            <br />
            Share the <u>classroom code</u> with your students so they can join
            your classroom.
          </div>
        ) : null}
      </div>
