                ...
                { this.props.notifications['results'].map(function (notification, i) {
                  return <div key={notification.id}>
                    ...
                    { notification['action_object'] &&
                      (notification['action_object']['content_type'] === 'lesson' ||
                       notification['action_object']['content_type'] === 'module')
                    ...
                    { notification['target'] &&
                      (notification['target']['content_type'] === 'lesson' ||
                       notification['target']['content_type'] === 'module')
